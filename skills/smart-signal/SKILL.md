...
name: smart-signal
description: >
  Smart Money Signal Strategy v1.0 — onchainos Agentic Wallet + Cost-Aware TP + Dev/Bundler Safety + Session Risk Control.
...
# Smart Money Signal Strategy v1.0
...
```
📡 Smart Money Signal Strategy v1.0 — Smart Money Signal Tracker
