...
name: ranking-sniper
description: >
  Ranking Sniper Strategy v1.0 — Ranking Sniper (Real Trading).
  Monitors the DEX leaderboard for newly listed tokens, filters through
  ...
  Triggered when the user mentions ranking strategy, ranking sniper,
  leaderboard sniper, top N sniper, or start ranking sniper.
...
```
🏆 Ranking Sniper Strategy v1.0 — Solana Ranking Sniper
